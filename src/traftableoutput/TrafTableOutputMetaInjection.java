 ...
 * @author Chris
 */
public class TrafTableOutputMetaInjection implements StepMetaInjectionInterface {
  ...
  public TrafTableOutputMetaInjection( TrafTableOutputMeta meta ) {
    this.meta = meta;
  }
  ...
  public TrafTableOutputMeta getMeta() {
    return meta;
  }
}
